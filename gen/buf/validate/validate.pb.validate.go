...
func (m *StringRules) validate(all bool) error {
	...
	case *StringRules_ProtobufFqn:
		...
		// no validation rules for ProtobufFqn
	case *StringRules_ProtobufDotFqn:
		...
		// no validation rules for ProtobufDotFqn
...
// Validate checks the field values on FieldMaskRules with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *FieldMaskRules) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on FieldMaskRules with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in FieldMaskRulesMultiError,
// or nil if none found.
func (m *FieldMaskRules) ValidateAll() error {
	return m.validate(true)
}

func (m *FieldMaskRules) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, FieldMaskRulesValidationError{
					field:  "Const",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return FieldMaskRulesValidationError{
				field:  "Const",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return FieldMaskRulesMultiError(errors)
	}

	return nil
}

// FieldMaskRulesMultiError is an error wrapping multiple validation errors
// returned by FieldMaskRules.ValidateAll() if the designated constraints
// aren't met.
type FieldMaskRulesMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m FieldMaskRulesMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m FieldMaskRulesMultiError) AllErrors() []error { return m }

// FieldMaskRulesValidationError is the validation error returned by
// FieldMaskRules.Validate if the designated constraints aren't met.
type FieldMaskRulesValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e FieldMaskRulesValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e FieldMaskRulesValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e FieldMaskRulesValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e FieldMaskRulesValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e FieldMaskRulesValidationError) ErrorName() string { return "FieldMaskRulesValidationError" }

// Error satisfies the builtin error interface
func (e FieldMaskRulesValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = FieldMaskRulesValidationError{}
